...
action_0,
 ...
 action_23,
 action_24,
 action_25 :: () => Prelude.Int -> ({-HappyReduction (Err) = -}
	   Prelude.Int 
	-> (Token)
...
happyExpList = Happy_Data_Array.listArray (0,81) ([34816,7,16,1928,4096,0,0,0,0,0,0,0,0,1928,4096,0,0,0,0,0,34816,7,0,64,31616,0,32768,120,1928,0,38912,7,0,0
	])
...
action_8 (17) = happyShift action_4
...
action_24 (9) = happyGoto action_17
...
happyNewToken action sts stk (tk:tks) =
	...
	PT _ (TS _ 4) -> cont 15;
	PT _ (TS _ 5) -> cont 16;
	PT _ (T_Id happy_dollar_dollar) -> cont 17;
	PT _ (T_MetavarId happy_dollar_dollar) -> cont 18;
	PT _ (T_ConstructorId happy_dollar_dollar) -> cont 19;
	_ -> happyError' ((tk:tks), [])
	}
