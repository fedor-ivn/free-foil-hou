...
instance Print Language.Lambda.Syntax.Abs.Command where
  prt i = \case
    Language.Lambda.Syntax.Abs.CommandCompute term -> prPrec i 0 (concatD [doc (showString "compute"), prt 0 term])
...
instance Print Language.Lambda.Syntax.Abs.ScopedTerm where
  prt i = \case
    Language.Lambda.Syntax.Abs.AScopedTerm term -> prPrec i 0 (concatD [prt 0 term])

instance Print Language.Lambda.Syntax.Abs.Pattern where
  prt i = \case
    Language.Lambda.Syntax.Abs.APattern varident -> prPrec i 0 (concatD [prt 0 varident])

instance Print Language.Lambda.Syntax.Abs.VarBinder where
  prt i = \case
    Language.Lambda.Syntax.Abs.AVarBinder varident type_ -> prPrec i 0 (concatD [prt 0 varident, doc (showString ":"), prt 0 type_])
...
instance Print Language.Lambda.Syntax.Abs.MetavarBinder where
  prt i = \case
    Language.Lambda.Syntax.Abs.AMetavarBinder metavarident types type_ -> prPrec i 0 (concatD [prt 0 metavarident, doc (showString ":"), doc (showString "["), prt 0 types, doc (showString "]"), prt 0 type_])
...
instance Print Language.Lambda.Syntax.Abs.UnificationConstraint where
  prt i = \case
    Language.Lambda.Syntax.Abs.AUnificationConstraint varbinders scopedterm1 scopedterm2 -> prPrec i 0 (concatD [doc (showString "\8704"), prt 0 varbinders, doc (showString "."), prt 0 scopedterm1, doc (showString "="), prt 0 scopedterm2])
